...
class TouchableScales extends StatefulWidget {
  const TouchableScales({
    super.key,
    required this.child,
    this.onPressed,
  ...
  @override
  State<TouchableScales> createState() => _TouchableScalesState();
}

class _TouchableScalesState extends State<TouchableScales>
  ...
  @override
  void didUpdateWidget(TouchableScales old) {
