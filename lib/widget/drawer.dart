        ...
        child: SafeArea(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                      ...
                      child: Column(children: [
                          ...
                          child: Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text("Дугаар: ${Utils.getPhone()}",
                                      style: const TextStyle(
                                          color: Colors.white60,
                                          fontSize: 13.0,
                                          fontWeight: FontWeight.bold)),
                                  Text("Дэлгүүр: ${Utils.getstoreName()}",
                                      style: const TextStyle(
                                          color: Colors.white60,
                                          fontSize: 13.0,
                                          fontWeight: FontWeight.bold))
                        ...
                        ListTile(
                            ...
                            leading: SvgPicture.asset(
                                ...
                                colorFilter: const ColorFilter.mode(
                                    Colors.white60, BlendMode.srcIn)),
                            title: const Text("Шилжиж ирсэн бараа",
                                style: TextStyle(
                                    color: Colors.white60,
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
                        ...
                        ListTile(
                            ...
                            leading: SvgPicture.asset(
                                ...
                                colorFilter: const ColorFilter.mode(
                                    Colors.white60, BlendMode.srcIn)),
                            title: const Text("Зарагдсан бараа",
                                style: TextStyle(
                                    color: Colors.white60,
                                    fontSize: 13.0,
                                    fontWeight: FontWeight.bold)),
            ...
            Column(children: [
              ListTile(
                  title: Row(children: [
                    SvgPicture.asset("assets/icons/drawer1.svg",
                        width: 24,
                        colorFilter: const ColorFilter.mode(
              ...
              ListTile(
                  title: Row(children: [
                    SvgPicture.asset("assets/icons/drawer3.svg",
                        width: 24,
                        colorFilter: const ColorFilter.mode(
                            kPrimaryColor, BlendMode.srcIn)),
                    const SizedBox(width: 10),
              ...
              Utils.getUserRole() == "BOSS"
                  ? ListTile(
                      title: Row(children: [
                        SvgPicture.asset("assets/icons/drawer2.svg",
                            width: 24,
                            colorFilter: const ColorFilter.mode(
                                kPrimaryColor, BlendMode.srcIn)),
                        const SizedBox(width: 10),
  ...
  _showLogOutWarning(BuildContext context) async {
    showDialog<void>(
      ...
      builder: (ctx) => CustomDialog(
          onPressedSubmit: () => _logoutFunction(context),
          title: 'Анхаар',
          desc: "Та програмаас гарахдаа итгэлтэй байна уу",
          type: 2),
    );
  }
    ...
    showModalBottomSheet(
        ...
        builder: (context) {
          return const FractionallySizedBox(
              heightFactor: 0.6,
              child: ChangeUserBottom(title: "Дэлгүүрийн дугаар солих"));
        });
  }
